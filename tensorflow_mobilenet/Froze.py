...
from FrozeMobilenetv2 import Mobilenetv2 as Model
from FrozeMobilenetv2 import Detection_or_Classifier
...
class Train:
    ...
    def __init__(self, sess):
        ...
        if Detection_or_Classifier=='classifier':
            ...
            self.train_data = DataLoader(root=os.path.join(self.dataset_root,'train'),classes=len(self.labels),batch=batch_size)
